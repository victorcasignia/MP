...
folder = "C:/Users/Victor Casignia/Desktop/CS284_MP_Data/tensorflow-great-barrier-reef/enhance"
...
for i in range(len(files)):
    ...
    if os.path.isfile(filepath):
        ...
        #cv2.imwrite(folder+'/OutputImages/' + prefix + '_ULAPDepthMap.jpg', np.uint8(refineDR * 255))
        ...
        #cv2.imwrite(folder+'/OutputImages/' + prefix + '_ULAP_TM.jpg', np.uint8(transmission[:, :, 2] * 255))


        # print('AtomsphericLight',AtomsphericLight)

        cv2.imwrite(folder+'/OutputImages/' + prefix + '_ULAP.jpg', sceneRadiance)
